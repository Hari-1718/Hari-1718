...
<p align="center">
Building scalable ML systems, GenAI applications, and production-ready full-stack solutions 🚀
</p>
...
- 💼 Experience in **AI, ML Research, NLP, and MERN Full-Stack Development**
- 🧠 Strong in **DSA, ML pipelines, GenAI systems, and backend APIs**
- 🚀 Passionate about taking **models → APIs → production**
...
- **🤖 EmoAgent-Bot**  
  Emotion-aware conversational AI using LLMs, prompt engineering, and intelligent response routing  
  *(LLMs · Prompt Engineering · NLP · FastAPI / Flask · Vector Search)*
...
- 📈 Improved ML model accuracy by **12% in one sprint**
- 🥇 **Top 10%** – IIIT-Hyderabad ML Program
- 🥈 **2nd Place** – Python Coding Contest (JNTU-GV)
- 🧩 Solved **60+ DSA problems** on LeetCode
- 🛠 Built & deployed **ML + Full-Stack production apps**
